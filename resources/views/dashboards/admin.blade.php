...
<div class="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
  ...
  <div class="flex flex-wrap gap-3">
    <a href="{{ route('users.index') }}" class="bg-blue-900 hover:bg-blue-800 text-white px-4 py-2 rounded-lg text-sm font-semibold">
      <i class="fa-solid fa-users-gear mr-2"></i>Manage Personnel
    </a>
    <a href="{{ route('users.lis-sync') }}" class="bg-slate-800 hover:bg-slate-700 text-white px-4 py-2 rounded-lg text-sm font-semibold">
      <i class="fa-solid fa-cloud-arrow-up mr-2"></i>LIS Sync
    </a>
    <a href="{{ route('property-inventory') }}" class="bg-emerald-700 hover:bg-emerald-600 text-white px-4 py-2 rounded-lg text-sm font-semibold">
